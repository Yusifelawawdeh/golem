...
class TestHardwarePresetsMixin(TestWithDatabase):
    ...
    def test_get_hw_preset(self):
        ...
        with self.assertRaises(DoesNotExist):
            assert not HardwarePresetsMixin.get_hw_preset(str(uuid.uuid1()))

    def test_create_hw_preset(self):
        preset_name = str(uuid.uuid1())
        preset_cpu_cores = 1
        ...
        preset_dict['name'] = str(uuid.uuid1())
        print(preset_dict)
    ...
    def test_delete_hw_preset(self):
        ...
        assert not HardwarePresetsMixin.delete_hw_preset(str(uuid.uuid1()))
